...
FOLDERS_TO_PREPARE = 80  # It will NOT convert full ModelNet40 dataset. Only given number of folders. However,
# network will not change its N_CATEGORIES parameter. To convert all dataset set = 80
